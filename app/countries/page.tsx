    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-12">
        <p className="text-sm text-slate-600">
          ...
          <Link className="ml-1 font-semibold text-ink underline-offset-2 hover:underline" href="/charts">charts overview</Link>, and
          <Link className="ml-1 font-semibold text-ink underline-offset-2 hover:underline" href="/insights">insights analysis</Link>.
        </p>
      </section>
    </>
  );
